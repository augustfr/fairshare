...
const updateExchangeCommand = new SlashCommandBuilder()
  ...
  .setDescription(
    "Fund an existing exchange pair with an outside user and/or change the rate. (Advanced users only)"
  )
  ...
  .addNumberOption((option) =>
    option
      .setName("amount")
      .setDescription(
        "The amount you want to add to the current balance of the exchange"
      )
  )
  .addNumberOption((option) =>
    option
