...
const setupCommand = new SlashCommandBuilder()
  ...
  .addNumberOption((option) =>
    option
      .setName("fee")
      .setDescription(
        "The percentage fee that will be added on to each transaction ('5' for '5%') (default is 8%)"
      )
  )
  .addNumberOption((option) =>
    option
      .setName("income")
      .setDescription(
        "The amount of daily income for each member (default is 50)"
      )
  );
